...
2. Products Guru:
    - Updated schema to combine inventory and products table into one 
    - Created detailed product page accessible from the product search page, displaying information about each individual product, allowing users to see all the sellers for the product, and order from a specific seller 
...
5. Social Guru: 
    - Changed Reviews relation schema to reflect changes in other relations
    - Added the ability to add a review in the order details page
    - Added working queries and back ends for updating and deleting queries that just need front end implementations like add_review
    - Next will be adding average stars to products that you can see before purchase, and upvotes will be added as an extra feature